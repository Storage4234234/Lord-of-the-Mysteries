...
public class GuardianBoxEntityRenderer extends EntityRenderer<GuardianBoxEntity> {
    ...
    private void renderFace(com.mojang.blaze3d.vertex.VertexConsumer vertexConsumer, Matrix4f matrix, float x1, float y1, float z1, float x2, float y2, float z2, float x3, float y3, float z3, float x4, float y4, float z4, int packedLight) {
        vertexConsumer.vertex(matrix, x1, y1, z1).color(1.0F, 1.0F, 1.0F, 0.2F).uv(0.0F, 1.0F).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(packedLight).normal(0.0F, 1.0F, 0.0F).endVertex();
        vertexConsumer.vertex(matrix, x2, y2, z2).color(1.0F, 1.0F, 1.0F, 0.2F).uv(1.0F, 1.0F).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(packedLight).normal(0.0F, 1.0F, 0.0F).endVertex();
        vertexConsumer.vertex(matrix, x3, y3, z3).color(1.0F, 1.0F, 1.0F, 0.2F).uv(1.0F, 0.0F).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(packedLight).normal(0.0F, 1.0F, 0.0F).endVertex();
        vertexConsumer.vertex(matrix, x4, y4, z4).color(1.0F, 1.0F, 1.0F, 0.2F).uv(0.0F, 0.0F).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(packedLight).normal(0.0F, 1.0F, 0.0F).endVertex();
    }
