...
public class MatterAccelerationEntities extends SimpleAbilityItem {
    ...
    public void appendHoverText(@NotNull ItemStack stack, @Nullable Level level, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        tooltipComponents.add(Component.literal("Upon use, accelerates the speed of all entities. If their speed passes a certain point, they deal damage to all surrounding entities and destroy all blocks around them."));
    ...
    public static void matterAccelerationEntities(LivingEntity entity) {
        ...
        for (LivingEntity entity1 : entity.level().getEntitiesOfClass(LivingEntity.class, entity.getBoundingBox().inflate(5))) {
            ...
            if (!BeyonderUtil.currentPathwayMatches(entity, BeyonderClassInit.SAILOR.get())) {
                entity.hurt(entity1.damageSources().lightningBolt(), 40);
            } else {
